      ...
      <div className="max-w-4xl mx-auto flex items-center justify-between relative">
        ...
        {userProfile && (
           <div className="flex items-center gap-2">
             ...
             <button
               onClick={onChatClick}
               className="p-2.5 rounded-full bg-white border border-green-200 text-green-700 hover:bg-green-50 hover:scale-105 transition-all relative shadow-sm"
               title="我的聊天室"
             >
             ...
             >
               <div className="flex flex-col items-end">
                 <span className="text-green-900 font-bold text-sm md:text-base leading-tight group-hover:text-green-700">
                   {formatPublicName(userProfile)}
                 </span>
                 <span className="text-green-600 text-[10px] font-bold bg-green-100 px-1.5 py-0.5 rounded-full whitespace-nowrap mt-0.5 group-hover:bg-white">
