...
export const RoleCard: React.FC<RoleCardProps> = ({ title, icon: Icon, colorHex, onClick, description }) => {
  return (
    <button
      onClick={onClick}
    ...
    >
      <div className="absolute -right-12 -top-12 w-48 h-48 bg-white opacity-10 rounded-full blur-2xl group-hover:opacity-20" />
